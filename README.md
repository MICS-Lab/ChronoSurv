...
We acknowledge [Kist et al. 2024](https://www.nature.com/articles/s41597-024-03596-3) and [The Cancer Genome Atlas Network](https://www.nature.com/articles/nature14129) for making the HANCOCK and the TCGA datasets available. We extend our gratitude to the contributors from [UNI](https://huggingface.co/MahmoodLab/UNI) and [BioClinicalBERT](https://huggingface.co/emilyalsentzer/Bio_ClinicalBERT) for releasing their pre-trained models to the research community.
